 ...
 * @api public
 * @method count
 * @see MongoDB driver cursor#close http://mongodb.github.io/node-mongodb-native/3.6/api/Cursor.html#count
 */
QueryCursor.prototype.count = function(callback) {
  return promiseOrCallback(callback, cb => {
    this.cursor.count(cb)
  })
}
